...
const BitcoinSend = () => {
  return (
    <div className='items-center flex flex-col bg-slate-700 overflow-hidden text-white h-screen'>
      ...
      <div className='mt-5 m-2 p-5'>
        <h1 className='text-red-400'>YOUR BALANCE WILL BE CREDITED AUTOMATICALLY, IF NOT CHAT US UP HERE
        </h1>
